...
function toProfilRecord(r: ServiceRecordFull): ProfilRecord {
  return {
    ...
    primaryHasScope: r.primaryHasScope ?? r.hasScope,
    hasScope: r.hasScope,
    secondaryWeapon: r.secondaryWeapon,
    secondaryWeaponSerial: r.secondaryWeaponSerial,
    secondaryHasScope: r.secondaryHasScope,
    thirdWeapon: r.thirdWeapon,
    thirdWeaponSerial: r.thirdWeaponSerial,
    thirdHasScope: r.thirdHasScope,
    tranquilizerWeapon: r.tranquilizerWeapon,
    tranquilizerWeaponSerial: r.tranquilizerWeaponSerial,
    tranquilizerHasScope: r.tranquilizerHasScope,
    cartInfo: r.cartInfo,
    boatInfo: r.boatInfo,
  };
}
